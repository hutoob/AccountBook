...
import com.example.accountbook.adapter.AccountAdapter;
import com.example.accountbook.db.AccountBean;
import com.example.accountbook.db.DBManager;
import com.example.accountbook.utils.BudgetDialog;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        searchIv=findViewById(R.id.main_lv_search);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.main_btn_edit:
                Intent itl=new Intent(this,RecordActivity.class);
                startActivity(itl);
                break;
            case R.id.main_btn_more:
                Intent itl1=new Intent(this,HistoryActivity.class);
                startActivity(itl1);
                break;
